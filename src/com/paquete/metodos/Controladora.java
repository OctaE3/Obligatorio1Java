    ...
    public static boolean ingresarEquipo1()
    {
        ...
        for(int i = 0; i < 1; i++)
        {
            ...
            for(Jugador unJugador : listaJugadoresSuplentesEq1)
            {
                ...
                {
                    for(Jugador jugadorT : listaJugadoresTitularesEq1)
                    {
                        if (jugadorT.get_numero() == dorsalSuplente)
                        {
                            System.out.println("Este dorsal ya esta en uso!");
                            i--;
                        }
        ...
        if (TecnicoEq1 != null && listaJugadoresTitularesEq1.size() == 1 && listaJugadoresSuplentesEq1.size() == 1)
        {
            return true;
        }
        return false;
    ...
    public static boolean ingresarEquipo2()
    {
        ...
        for(int i = 0; i < 1; i++)
        {
            ...
            for(Jugador unJugador : listaJugadoresSuplentesEq2)
            {
                ...
                {
                    for(Jugador jugadorT : listaJugadoresTitularesEq2)
                    {
                        if (jugadorT.get_numero() == dorsalSuplente)
                        {
                            System.out.println("Este dorsal ya esta en uso!");
        ...
        Equipo team = new Equipo((byte) 2,nombre,listaJugadoresTitularesEq2,listaJugadoresSuplentesEq2,TecnicoEq2);
        Equipo2 = team;

        if (TecnicoEq2 != null && listaJugadoresTitularesEq2.size() == 1 && listaJugadoresSuplentesEq2.size() == 1)
        {
            return true;
        }
        return false;
